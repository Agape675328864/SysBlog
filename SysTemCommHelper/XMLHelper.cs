...
namespace Agape.Xml.Common
{
    public class XmlHelper
    {
        ...
        public static string GetSNSTemplate(string condition, string path)
        {
        ...
        public static string GetEmailTemplate(string templateId, string path)
        {
            XmlDocument xdoc = new XmlDocument(); //建立文档对象
            xdoc.Load(path); //加载xml文件

            string Condition = "//Email[@id='" + templateId + "']"; //需要查找节点的条件
